...
export class ColaboradoresListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._colaboradoresService.onContactsChanged
...
/*         this._colaboradoresService.onSelectedContactsChanged
     ...
     * Delete Contact
     */
    // deleteContact(colaborador): void
    // {
    ...
    //         if ( result )
    //         {
    //             this._colaboradoresService.deleteContact(colaborador);
    //         }
    ...
    {
        this._colaboradoresService.toggleSelectedContact(contactId);
    }
    ...
    //     this._colaboradoresService.updateUserData(this.user);
    // }
...
export class FilesDataSource extends DataSource<any>
{
    ...
    {
        return this._colaboradoresService.onContactsChanged;
    }
